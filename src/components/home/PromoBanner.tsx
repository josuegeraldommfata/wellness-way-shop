        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 relative overflow-hidden rounded-2xl gradient-hero min-h-[250px] flex items-center p-8">
            ...
            <div className="absolute right-0 top-0 bottom-0 w-1/2 opacity-30">
              ...
              <div className="absolute inset-0 bg-gradient-to-l from-transparent to-[hsl(340,75%,55%)]" />
            </div>
          </div>

          {/* Side banner */}
          <div className="relative overflow-hidden rounded-2xl gradient-hero min-h-[250px] flex items-center p-8">
